...
const Home = () => {
  return (
    <div className="">
      ...
      <div className=" bg-white w-full  mt-[20rem]  pl-[10rem] rounded-2xl flex flex-row">
        <Image className="h-[20rem]  w-[20rem] " src={photo} />
        <div>
          <p className="text-red-600  text-[2rem] font-semibold mt-14">
            About data.gov
          </p>
          <p className="text-black text-lg w-[40rem]">
            Lorem ipsum dolor sit amet consectetur dipisicing elit. Officiis ea
            provident beatae maiores neque cum adipisci a eaque. Fugit,
